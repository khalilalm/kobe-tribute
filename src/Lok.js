        ...
        <div className="lok-container">
          <div className="lok-items">
            ...
            <p className="lok-text">
              Kobe Bryant, the 5x NBA champion, father of 3 children and an
              inspiration to many. He was born philidelphia. In high school, he
              gained national recognition for his amazing performences during
              the beginning of his high school career which allowed him to join
              the varsity team.“I heard a lot of buzz about a 14-year-old in our
              middle school, so I went to watch one of his games,” said Kobe's
              Middle school Coach -
              <a
                href="https://www.inquirer.com/high-school-sports/gregg-downer-kobe-bryant-lower-merion-high-school-basketball-20200128.html?outputType=amp"
                target="_blank"
              >
                The Philadelphia Inquirer
              </a>
              . The rest is history, Kobe went on to score 2,883 points in his
              high school career
            </p>
          </div>
          ...
          <div className="lok-items">
            ...
            <p className="lok-text">
              ...
              situation saying,"When I first did it, right there, I was trying
              to feel if the tendon is there or if it’s gone. I realized it
              wasn’t there. I was literally trying to pull the tendon up, so
              hopefully I could walk and kind of hobble through the last two and
              a half minutes and try to play." Kobe's recovery tooks 6 weeks
              however, after his recovery his statistics increased greater than
              before.
            </p>
          </div>
          <div className="lok-items">
            <img
              ...
              className="kobe-college-image"
            />
            <div className="lok-item-subtitles">
              <h6 >Achievments</h6>
            </div>
            ...
            <ul className="lok-text-list">
              ...
              <li className="lok-text-list-item">
            ...
            <p className="lok-text">
              Kobe went on to score a total of 33,643 points in his career
              making one of him the top 4 scorers of all time!!!
            </p>
          </div>
        </div>
